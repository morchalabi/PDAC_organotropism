# This script plots Extended Data Fig. 5c-d; it takes healthy fetal lung and liver data and checks the enrichment
...
pdf(file = 'c-d.pdf', width = 14, height = 7.5)
...
p_ =  VlnPlot(lng_liv, features = 'liv_score', group.by = "cell_type", pt.size = 0, combine = FALSE, log = F, sort = F, cols = c('blue','red'))[[1]]+
  ...
  stat_summary(fun = mean, geom ='point', size = 19, colour = "white", shape = 95)
