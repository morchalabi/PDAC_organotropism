# This scripts plot Fig. 4g-h; it computes single-sample gene set enrichment (ssGSE) scores of PDAC-recurrence signatures in MetMap500 cohort.
# MetMap500's cohort is bulk RNAseq data of cell lines from various cancer types including PDAC with measured organotropism.
...
# exprsMat = t(read.delim(file = 'Misc/CCLE_cell_lines_exprs_mat.csv', sep = ',', check.names = F, as.is = T, header = T, row.names = 1))
...
pdf(file = 'g-h.pdf', width = 7.5, height = 7.5, fonts = 'Helvetica')
