# This script plots Fig. 4c-f; it takes the data of primary tumors of adult lung and liver and checks the enrichment of PDAC-recurrence signatures in them.
